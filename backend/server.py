...
def init_db():
    ...
    cur.executescript("""
        CREATE TABLE IF NOT EXISTS personality (
            ...
            description TEXT    NOT NULL DEFAULT 'You are a helpful AI assistant.',
    ...
    if cur.fetchone()[0] == 0:
        cur.execute("""
            INSERT INTO personality (description, tone, style)
            VALUES ('You are a helpful, witty AI assistant.', 'Friendly', 'Conversational')
        """)
    conn.commit()
    conn.close()
